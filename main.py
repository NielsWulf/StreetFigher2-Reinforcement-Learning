...
def main():
    ...
    train_parser.add_argument("--framestack", type=int, default=8, help="Number of frames to stack (default: 8)")
    ...
    eval_parser.add_argument("--model_path", type=str, default="./models/best_model_30000", help="Path to the trained model (default: ./models/best_model_30000)")
